...
<html:form action="/listConteudos" onsubmit="return false" method="post">
	...
	Título: <html:text property="titulo" size="30"/>&nbsp;&nbsp;&nbsp;Linhas por Página: <html:text property="linhas" size="5"/>
	...
	<html:submit value="Executar" styleClass="styledButton"  
    				 ...
    				 onmouseout="changeImage(this, 2);" onclick="ajaxSubmitGeneric( document.listConteudos, 'mainbody')"/><br>
	...
	<tiles:insert page="/backoffice/conteudo/listConteudosBody.jsp"/>
</html:form>
