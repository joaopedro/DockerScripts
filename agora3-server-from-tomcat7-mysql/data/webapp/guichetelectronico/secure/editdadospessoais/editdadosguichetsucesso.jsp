...
<!-- BARRA DO TITULO PRINCIAPL DA AREA CENTRAL -->
			<div class="barraTitulo">
				<div class="textoTitulo"><fmt:message key="guichetelectronico.editdados.sucesso.titulo" bundle="${guichetBundle}"/></div>
			</div>
			
			<html:form action="/secure/editdadospessoais" method="post">
			<div id="areaCentral">	
				<!-- MENSAGEM DE ERRO -->
				<div class="mensagenCaixa" >
					...
					<span class="info"><fmt:message key="guichetelectronico.editdados.sucesso.mensagemOk" bundle="${guichetBundle}"/></span>
				</div>
				<!-- LINHA DO BOTÃO -->
				<div class="buttonRow">
