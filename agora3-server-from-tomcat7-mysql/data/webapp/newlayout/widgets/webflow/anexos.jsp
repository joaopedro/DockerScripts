...
<c:if test="${empty _resumo}">
    ...
    <form:form  action="${flowExecutionUrl}" class="dynForm" method="post" enctype="multipart/form-data">
		...
		<div class="webflow_formdiv">
            ...
            <c:import url="/newlayout/widgets/webflow/uploadparts/anexosFileList.jsp">
            ...
            <div class="button" style="margin-top:10px;">
                <input type="submit" name="_eventId_add" value="${adicionar} +" class="" title="${adicionar}" />
            </div>
            ...
            <c:if test="${not empty dynamic.removedDocuments}">
                ...
                <fieldset>
                    ...
                    <div class="button" style="margin-top:10px; text-align: right;">
                        <input type="submit" name="_eventId_recover" value="${recuperar}" class="" title="${recuperarTitle}" />
                    </div>
                </fieldset>
            </c:if>
            <br />
            ...
            <div class="button">
                <input type="submit" name="_eventId_back" value="${anterior}" class="" title="${anteriorTitle}"/>
                <input type="submit" name="_eventId_next" value="${seguinte}" class="BT_primary" title="${seguinteTitle}" />
            </div>
