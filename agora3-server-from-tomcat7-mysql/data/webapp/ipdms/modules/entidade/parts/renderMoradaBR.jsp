...
<c:choose>
	...
	<tr>
		...
		<th class="centro" style="width:20%"><fmt:message key="ipdms.modules.entidade.br.estado" /></th>
		<th class="centro" style="width:20%" ><fmt:message key="ipdms.modules.entidade.br.municipio" /></th>
		<th class="centro" style="width:20%" ><fmt:message key="ipdms.modules.entidade.br.endereco" /></th>
		<th class="centro" style="width:20%" ><fmt:message key="ipdms.modules.entidade.br.numero" /></th>	
		<th class="centro" style="width:5%" ><fmt:message key="ipdms.modules.entidade.br.complemento" /></th>
		<th class="centro" style="width:8%" ><fmt:message key="ipdms.modules.entidade.br.bairro" /></th>
		<th class="centro" style="width:8%" ><fmt:message key="ipdms.modules.entidade.br.cidade" /></th>
		<th class="centro" style="width:8%" ><fmt:message key="ipdms.modules.entidade.br.cep" /></th>
	...
	<c:forEach items="${entidadeFormBean.moradas}" var="moradaBR" varStatus="i">
	<tr>
	<c:if test="${entidadeFormBean.tipoEntidade eq '2'}">
		<td class="centro">
	...
	<td class="centro">${moradaBR.descricaoEstado}</td>
	<td class="centro">${moradaBR.descricaoMunicipio}</td>
	<td class="centro">${moradaBR.endereco}</td>	
	<td class="centro">${moradaBR.numero}</td>
	<td class="centro">${moradaBR.complemento}</td>
	<td class="centro">${moradaBR.bairro}</td>
	<td class="centro">${moradaBR.cidade}</td>
	<td class="centro">${moradaBR.cep}</td>
	
	<c:set var="checked" value="" />
	<c:if test="${moradaBR.principal}"><c:set var="checked" value="checked=checked" /></c:if>
