...
<fmt:message key="data.fl.delete.confirm" var="deleteConfirm" bundle="${calendarioBundle}" />
...
<c:choose>
	...
	<c:otherwise>
		<html:form styleId="flDeleteForm" action="fl/delete">
			...
			<display:footer>
				...
				<td class="tableFooter alignCenter">
					<img src="${pageContext.request.contextPath}/images/icon/icon-lixo.png"
						onclick="cancelar(event,'${removerFeriado}','${deleteConfirm}',deleteFeriadofl,'${sim}','${nao}');" 
