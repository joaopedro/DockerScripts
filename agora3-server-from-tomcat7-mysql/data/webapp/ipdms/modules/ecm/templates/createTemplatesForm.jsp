...
<html:form styleId="templateEstruturaForm" action="/saveTemplateEstrutura">
<fieldset>
	<legend>${criar} ${templateDes}</legend>
	...
	<div class="row formlabel_sf" >
		<div class="leftTab label" style="width: 17%; " title="${descricao}">
			<label for="descricaoTemplate">${descricao} *</label>
		</div>
		<div class="label" style="width: 80%;" title="${descricao}">
			<html:text property="descricaoTemplate" />
		</div>
	</div>
	...
	<div class="alignLeft" style="margin-top:1%;">
		<div class="left">
			<img src="${pageContext.request.contextPath}/images/icon/icon-criarNovo.png" onclick="createTemplateConteudo();" class="cursorMao" alt="${criar} ${conteudosDesSingular}" title="${criar} ${conteudosDesSingular}" />
		</div>
		<div class="right">
			<div class="texto" title="${criar} ${conteudosDesSingular}">&nbsp;<a href="#" onclick="createTemplateConteudo();">${criar} ${conteudosDesSingular}</a></div>
		</div>
	</div>
	...
	<div class="buttonRow">
		<input type="button" class="btForm" value='${submit}' onclick="save('templateEstruturaForm');" title='${submitTitle}' />
