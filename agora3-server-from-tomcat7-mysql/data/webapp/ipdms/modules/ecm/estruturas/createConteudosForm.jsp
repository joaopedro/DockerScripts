...
<fieldset style="margin-left:10px; margin-top:10px; width:95%;">
	...
	<div class="row formlabel_sf" >
		<div class="leftTab label" style="width: 12%; " title="${descricao}">
	  	...
	  	<div class="label" style="width: 33%;" title="${descricao}">
			<input type="text" id="descricaoConteudo" name="descricaoConteudo" value="${descricaoConteudo}" size="25" maxlength="150"/>
	  	</div>
	</div>
	...
	<div class="buttonRow">
		<input type="button" class="btForm" title="${gravar}" value="${gravar}" onclick="saveConteudo();" />
		<input type="button" class="btFormEscuro" title="${cancelar}" value="${cancelar}" onclick="cancelConteudo();" />
	</div>	
</fieldset>