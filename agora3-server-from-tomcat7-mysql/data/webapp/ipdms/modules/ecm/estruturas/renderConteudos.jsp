...
<c:choose>
	<c:when test="${not empty estruturaForm.conteudos}">
		<table cellpadding="0" cellspacing="0" class="centro">
			...
			<c:forEach items="${estruturaForm.conteudos}" var="conteudo" varStatus="i">
				<tr style="height:30px;">
					<td class="centro">${conteudo.descricaoConteudo}</td>
					<td class="alignCenter">
						<img class="cursorMao" src="${pageContext.request.contextPath}/images/icon/icon-pesquisa.png" onclick="createConteudo('${i.index}');" title="${pesquisar}" alt="${pesquisar}" />												
					</td>
					<td class="alignCenter">
