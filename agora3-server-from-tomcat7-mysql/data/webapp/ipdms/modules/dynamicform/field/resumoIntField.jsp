...
<div class="row" style="text-align:left;">
	...
	<tr id="${field.siglaId}_val" style="display: none;">
		<td colspan="2">
			...
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 25%; "><b><fmt:message key="ipdms.dynamicform.field.minvalue" />:</b></div>
				<div class="label" style="width: 70%;">${field.minValue}</div>
			</div>
			
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 25%; "><b><fmt:message key="ipdms.dynamicform.field.maxvalue" />:</b></div>
				<div class="label" style="width: 70%;">${field.maxValue}</div>
			</div>
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 25%; "><b><fmt:message key="ipdms.dynamicform.field.inputsize" />:</b></div>
				<div class="label" style="width: 70%;">${field.inputSize}</div>
			</div>
