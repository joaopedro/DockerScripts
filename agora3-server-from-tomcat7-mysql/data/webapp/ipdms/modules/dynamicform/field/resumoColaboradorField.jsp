...
<div class="row formlabel_sf" style="height:30%;">
	<div class="leftTab label" style="width: 18%; "><b><fmt:message key="ipdms.dynamicform.field.organica" />:</b></div>
	<div class="label" style="width: 65%;">${field.organica.designacao}</div>
</div>
