...
<div class="row" style="text-align:left;">
	...
	<tr id="${field.siglaId}_val" style="display: none;">
		<td colspan="2">
			...
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 30%; "><b><fmt:message key="ipdms.dynamicform.field.numberofrows" />:</b></div>
				<div class="label" style="width: 60%;">${field.numberOfRows}</div>
			</div>
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 30%; "><b><fmt:message key="ipdms.dynamicform.field.numberofcolumns" />:</b></div>
				<div class="label" style="width: 60%;">${field.numberOfColumns}</div>
			</div>
