...
<c:if test="${field.defaultValueIsCurrentDay}">
<div class="row formlabel_sf" style="height:30%;">
	...
	<div class="label" style="width: 65%;"><fmt:message key="ipdms.dynamicform.field.currentdaydefault" /></div>
</div>
</c:if>
		...
		<td colspan="2">
			...
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 20%; ">
					<b><fmt:message key="ipdms.dynamicform.field.beforecurrentday" />:</b>
				</div>
				<div class="label" style="width: 5%;">
					<c:choose>
						<c:when test="${field.beforeToday}"><fmt:message key="webflow.sim" /></c:when>
						<c:otherwise><fmt:message key="webflow.nao" /></c:otherwise>
					</c:choose>
				</div>
				<div class="leftTab label" style="width: 20%; ">
					<b><fmt:message key="ipdms.dynamicform.field.aftercurrentday" />:</b>
				</div>
				<div class="label" style="width: 5%;">
					<c:choose>
						<c:when test="${field.afterToday}"><fmt:message key="webflow.sim" /></c:when>
						<c:otherwise><fmt:message key="webflow.nao" /></c:otherwise>
					</c:choose>
				</div>
			</div>
			
			<c:if test="${not empty field.beforeThen}">
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 20%; ">
					<b><fmt:message key="ipdms.dynamicform.field.beforethen" />:</b>
				</div>
				<div class="label" style="width: 75%;">
					${field.beforeThen}
				</div>
			</div>
			</c:if>
			<c:if test="${not empty field.afterThen}">
			<div class="row formlabel_sf" style="height:30%;">
				<div class="leftTab label" style="width: 20%; ">
					<b><fmt:message key="ipdms.dynamicform.field.afterthen" />:</b>
				</div>
				<div class="label" style="width: 75%;">
					${field.afterThen}
				</div>
