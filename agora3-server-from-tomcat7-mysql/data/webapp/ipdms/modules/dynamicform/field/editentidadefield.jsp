...
<div>
	<table style="border:none;" cellpadding="0" cellspacing="0" class="headings">
		...
		<tr><td class="titulo2"><fmt:message key="ipdms.dynamicform.field.editentidade.subtitle" /></td></tr>
	</table>
</div>
...
<form:form modelAttribute="define-dynamicform" >
	...
	<div class="row formlabel_sf" >
		<div class="leftTab label" style="width: 20%;" title="<fmt:message key='ipdms.dynamicform.field.entidaderole' />">
			<label for="editField.field.role.id">
  				<label for="selectEntidadeRole"><fmt:message key="ipdms.dynamicform.field.entidaderole" /> *</label>
  			</label>
  		</div>
  		<div class="label" style="width: 65%; " title="<fmt:message key='ipdms.dynamicform.field.entidaderole' />">
  			<html:select name="dynamicForm" property="editField.field.role.id" styleId="selectEntidadeRole">
  				<html:option value="0">&nbsp;</html:option>
  				<html:optionsCollection name="dynamicForm" property="roles" label="descricao" value="id"/>
  			</html:select>	
  		</div>
	</div>
