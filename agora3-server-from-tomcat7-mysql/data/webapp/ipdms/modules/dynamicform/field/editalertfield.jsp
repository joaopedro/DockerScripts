...
<div>
	<table style="border:none;" cellpadding="0" cellspacing="0" class="headings">
		...
		<tr><td class="titulo2"><fmt:message key="ipdms.dynamicform.field.editalert.subtitle" /></td></tr>
	</table>
</div>
<br/>
...
<form:form modelAttribute="define-dynamicform" >
	...
	<div class="row formlabel_sf" style="height:30%;">
		<div class="leftTab label" style="width: 20%; " title="<fmt:message key="ipdms.dynamicform.field.defaultvalue" />" >
			<label for="editField.field.defaultValue"><fmt:message key="ipdms.dynamicform.field.defaultvalue" /></label>
		</div>
