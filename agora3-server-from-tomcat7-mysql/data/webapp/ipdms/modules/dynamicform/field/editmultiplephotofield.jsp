...
<div>
	<table style="border:none;" cellpadding="0" cellspacing="0" class="headings">
		...
		<tr><td class="titulo2"><fmt:message key="ipdms.dynamicform.field.editmultiplephoto.subtitle" /></td></tr>
	</table>
</div>
...
<form:form modelAttribute="define-dynamicform" >
	...
	<div class="row formlabel_sf" style="height:30%;">
		<div class="leftTab label" style="width: 20%; " title="<fmt:message key='ipdms.dynamicform.field.maxnumberofphotos' />">
			<label for="editField.field.maxNumberOfPhotos">
				<fmt:message key="ipdms.dynamicform.field.maxnumberofphotos" /> *
			</label>
		</div>
		<div class="label" style="width: 75%;" title="<fmt:message key='ipdms.dynamicform.field.maxnumberofphotos' />">
			<html:text name="dynamicForm" property="editField.field.maxNumberOfPhotos" 
				styleId="editField.field.maxNumberOfPhotos" />
		</div>
	</div>
	<br/>	
	<div class="buttonRow">
