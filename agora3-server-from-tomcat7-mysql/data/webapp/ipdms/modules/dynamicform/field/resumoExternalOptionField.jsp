...
<div class="row formlabel_sf" style="height:30%;">
	<div class="leftTab label" style="width: 22%; "><b><fmt:message key="ipdms.dynamicform.field.externaloption.serviceclass" />:</b></div>
	<div class="label" style="width: 65%;">${field.classString}</div>
</div>
