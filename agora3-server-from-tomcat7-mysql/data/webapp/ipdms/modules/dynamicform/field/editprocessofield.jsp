...
<div>
	<table style="border:none;" cellpadding="0" cellspacing="0" class="headings">
		...
		<tr><td class="titulo2"><fmt:message key="ipdms.dynamicform.field.editprocesso.subtitle" /></td></tr>
	</table>
</div>
...
<form:form modelAttribute="define-dynamicform" >
	...
	<jsp:include page="editStandardField.jsp"></jsp:include>
		...
		<div class="leftTab label" style="width: 20%;" title="<fmt:message key='ipdms.dynamicform.field.processofield.accaonainstrucao' />">
			<label for="editField.field.action">
  				<fmt:message key="ipdms.dynamicform.field.processofield.accaonainstrucao" />
  			</label>
  		</div>

  		<div class="label" style="width: 65%; " title="<fmt:message key='ipdms.dynamicform.field.processofield.accaonainstrucao' />">
  		
				<html:select name="dynamicForm" property="editField.field.action">
				<c:forEach items="${dynamicForm.actionsOnStart}" var="ac">
						<html:option value="${ac}"><fmt:message key='${ac.resource}'/></html:option>
				</c:forEach>	
				</html:select>
  		</div>
	</div>
