...
<html:form action="applicationFlow" method="post">
	...
	<div class="webflow_formdiv">
		...
		<c:choose>
			<c:when test="${not empty teste.docAnexadoBarcodeStickerList}">
				...
				<c:forEach items="${teste.docAnexadoBarcodeStickerList}" var="sticker" varStatus="i">
					<tr>
		...
		<div style="margin-top:10px;">
			...
			<html:submit property="_eventId_createqrcode" value="${criarCodigo}" title="${criarCodigo}" styleClass="btForm" onclick="webflowAjaxRequest(event);"/>
