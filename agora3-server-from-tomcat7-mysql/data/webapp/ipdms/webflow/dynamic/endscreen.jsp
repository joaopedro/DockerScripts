    ...
    <table width="100%" cellpadding="1" cellspacing="1" style="border:none">
        ...
        <c:if test="${not dynamic.variante.visivelExterior}">
            ...
            <tr>
                ...
                <a href="${pageContext.request.contextPath}/currentNotification.do2?processId=${dynamic.servicoOnline.workflowId}&processType=${dynamic.servicoOnline.variante.processo.codigoWorkflow}" class="webflow_link">${distruirprocessoAqui}</a></td>
            </tr>
        </c:if>
        ...
        <tr>
            <td colspan="2" style="text-align:center;">
                <html:button property="_eventId_next" value="${terminar}" title="${terminarTitle}" styleClass="btForm" onclick="window.location.href = '${referer}';"/>
            </td>
        </tr>
    </table>
</form:form>