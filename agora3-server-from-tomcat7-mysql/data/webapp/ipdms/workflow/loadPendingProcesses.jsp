...
<script type="text/javascript">
	...
	//Faz a chamada Ajax para carregar a listagem de utilizadores dependentes e dos processos pendentes
	//loadListprocess('utilizadores','${CONTEXT_PATH}/listautilizadoresdependentesajax.do2?suspender=false');
	loadListprocess('processos','${CONTEXT_PATH}/listaprocessospendentesajax.do2?suspender=false');	
...
<div class="row" style="text-align:left; padding-top:0px; ">
	<table style="border:none;" cellpadding="0" cellspacing="0" class="headings">
		<tbody><tr><td class="titulo1"><fmt:message key="ipdms.processos.pendentes"/></td></tr></tbody>
	</table>					
</div>
<div id='extInfo' ></div>
