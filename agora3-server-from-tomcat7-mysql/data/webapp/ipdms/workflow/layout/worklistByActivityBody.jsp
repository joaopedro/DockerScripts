...
<fmt:message key="ipdms.notification.pesqisa.etapas.titulo" var="titulo" />
...
<fmt:message key="ipdms.notification.pesqisa.etapas.tramitar.empty" var="tramitarEmpty" />
<fmt:message key="ipdms.forms.anterior" var="anterior" />
<fmt:message key="ipdms.forms.anterior.title" var="anteriorTitle" />

<script type="text/javascript">
	var etapaId = ${etapa.numeroConteudo};
	...
	var rules = {
		'#worklist tbody tr': function(el) {
			...
			el.onclick = function(event){
				var queryString = 'etapaId=' + etapaId + '&';
...
<div class="row" style="text-align:left; padding-top:0px; ">
	<table style="border:none;" cellpadding="0" cellspacing="0" class="headings">
		<tbody>
		  <tr>
		    <td class="titulo1">${titulo}: ${etapa.titulo}</td>
		  </tr>
		</tbody>
	</table>					
</div>
...
<form name="anterior" action="notifsetapa.do2" method="post">
<div class="buttonRow">
