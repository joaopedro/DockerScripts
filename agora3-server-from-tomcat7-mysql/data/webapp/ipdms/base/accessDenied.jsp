...
<script type="text/javascript">	
	document.title = '${productName} - <fmt:message key="error.accessdenied.exception.title" />';	 
</script>
...
<div class="row" style="padding-top:0px; text-align:left; ">
	<table style="border:none" cellpadding="0" cellspacing="0" class="headings">
		<tbody>
		  <tr>
		    <td class="titulo1"><fmt:message key="error.accessdenied.exception.title" /></td>
		  </tr>
		</tbody>
	</table>					
</div>
...
<div class="row formlabel_sf" >
	 <div class="mensagenCaixa">
		...
		<div style="float:right; width:95%; vertical-align:middle; margin-top:4px; ">
			<div class="info">
				<fmt:message key="error.accessdenied.exception.message" />
				<c:if test="${!noReturnLink}">
					<fmt:message key="error.accessdenied.exception.returnlink">
